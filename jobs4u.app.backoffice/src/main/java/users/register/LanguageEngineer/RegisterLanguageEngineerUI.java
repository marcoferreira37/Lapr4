...
public class RegisterLanguageEngineerUI extends AbstractUI {
    ...
    private final RegisterLanguageEngineerController controller = new RegisterLanguageEngineerController(PersistenceContext.repositories().
            jobs4UUsers(), new Jobs4UUserBuilderFactory());


    @Override
    protected boolean doShow() {
        System.out.println("Please provide the Language Engineer details\n");
        try {
            ...
            controller.registerLanguageEngineer(username, password, name, lastName, email);
            System.out.println();
    ...
    public String headline() {
        return "Register Language Engineer";
    }
}
